...
extension _CombineXWrapper where Base: NSObject {
    ...
    func methodInvoked(for selector: Selector) -> AnyPublisher<(), Never> {
    ...
    func publish(_ selector: Selector) -> AnyPublisher<[Any?], Never> {
